...
package tcb.poc.confluent.kafka.account.consumer.avro;
...
import static tcb.poc.confluent.kafka.account.consumer.avro.StockTickConsumerAvroApplication.TOPIC_NAME;
